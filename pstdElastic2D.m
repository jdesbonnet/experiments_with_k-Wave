...
if numDim(mu) == 2 && use_sg
    ...
    mu_sgxy  = interpn(kgrid.x, kgrid.y, mu, kgrid.x + kgrid.dx/2, kgrid.y + kgrid.dy/2, '*linear');
...
if kelvin_voigt_model
    if numDim(eta) == 2 && use_sg
        ...
        eta_sgxy  = interpn(kgrid.x, kgrid.y, eta, kgrid.x + kgrid.dx/2, kgrid.y + kgrid.dy/2, '*linear');
